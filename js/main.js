...
import { toggleTheme, enableDarkMode, showToast, applyTranslations, closeModals, showAddProfessionModal } from './ui.js';
...
import { subscribeToRealtimeUpdates } from './realtime.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!hasVisitedBefore && !window.location.href.includes('landing.html')) {
...
async function setupApplication(preloadedUI = false) {
    try {
        ...
        // Setup event listeners in parallel with data loading
        setupEventListeners();
